window.onload = function(){
    $("#submitSurvey").on("click",function () {
        ...
        var satisfaction,requirement_meet,features,intersted,timeline;
        satisfaction = $("input[name='statisfection']:checked").val() !== undefined ? $("input[name='statisfection']:checked").val(): "";
        ...
        send_survey_mail({"log_id":key,"name":username,"satisfaction":satisfaction,"requirement_meet":requirment,"timeline":timeline,"features":features,"intersted":intersted},function (res) {
            if(res){
