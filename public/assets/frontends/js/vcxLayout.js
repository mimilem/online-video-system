...
var getBestDimensions = function getBestDimensions(minRatio, maxRatio, Width, Height, count) {
  ...
  var tWidth;
  var tHeight;
  var tRatio; // Iterate through every possible combination of rows and columns
  // and see which one has the least amount of whitespace

  for (var i = 1; i <= count; i += 1) {
    var cols = i;
    var rows = Math.ceil(count / cols); // Try taking up the whole height and width
...
var getLayout = function getLayout(opts, elements) {
  var maxRatio = opts.maxRatio,
      ...
      offsetLeft = _opts$offsetLeft === void 0 ? 0 : _opts$offsetLeft,
      _opts$offsetTop = opts.offsetTop,
      offsetTop = _opts$offsetTop === void 0 ? 0 : _opts$offsetTop;
  ...
  var rows = [];
  var row;
  var boxes = []; // Iterate through the children and create an array with a new item for each row
  ...
  for (var i = 0; i < ratios.length; i += 1) {
    ...
    var targetHeight = dimensions.targetHeight; // If we're using a fixedRatio then we need to set the correct ratio for this element
  ...
  y = (containerHeight - totalRowHeight) / 2; // Iterate through each row and place each child
  ...
  for (var _i3 = 0; _i3 < rows.length; _i3 += 1) {
    ...
    for (var j = 0; j < row.ratios.length; j += 1) {
      ...
      _targetHeight = row.height; // If we're using a fixedRatio then we need to set the correct ratio for this element
...
module.exports = function (opts, elements) {
  var _opts$maxRatio = opts.maxRatio,
      maxRatio = _opts$maxRatio === void 0 ? 3 / 2 : _opts$maxRatio,
      _opts$minRatio = opts.minRatio,
      minRatio = _opts$minRatio === void 0 ? 9 / 16 : _opts$minRatio,
      _opts$fixedRatio = opts.fixedRatio,
      fixedRatio = _opts$fixedRatio === void 0 ? false : _opts$fixedRatio,
      _opts$bigPercentage = opts.bigPercentage,
      bigPercentage = _opts$bigPercentage === void 0 ? 0.8 : _opts$bigPercentage,
      _opts$bigFixedRatio = opts.bigFixedRatio,
      bigFixedRatio = _opts$bigFixedRatio === void 0 ? false : _opts$bigFixedRatio,
      _opts$bigMaxRatio = opts.bigMaxRatio,
      bigMaxRatio = _opts$bigMaxRatio === void 0 ? 3 / 2 : _opts$bigMaxRatio,
      _opts$bigMinRatio = opts.bigMinRatio,
      bigMinRatio = _opts$bigMinRatio === void 0 ? 9 / 16 : _opts$bigMinRatio,
      _opts$bigFirst = opts.bigFirst,
      bigFirst = _opts$bigFirst === void 0 ? true : _opts$bigFirst,
      _opts$containerWidth = opts.containerWidth,
      containerWidth = _opts$containerWidth === void 0 ? 640 : _opts$containerWidth,
      _opts$containerHeight = opts.containerHeight,
      containerHeight = _opts$containerHeight === void 0 ? 480 : _opts$containerHeight;
  ...
  var boxes = [];
  var bigBoxesIdx = 0;
  var smallBoxesIdx = 0; // Rebuild the array in the right order based on where the bigIndices should be
...
var getLayout = __webpack_require__(/*! ./getLayout */ "./src/getLayout.js");
...
var positionElement = function positionElement(elem, x, y, w, h, animate) {
  ...
  var fixAspectRatio = function fixAspectRatio() {
    var sub = elem.querySelector('.VCX_root');
    ...
    if (sub) {
      ...
      sub.style.width = "".concat(w, "px"); // sub.style.height = height + 'px';
  ...
  if (animate && $) {
    ...
    if (!elem.classList.contains('vcx-layout')) {
      elem.classList.add('vcx-layout');
    }
  }
...
module.exports = function (container, opts) {
  var _opts$animate = opts.animate,
      animate = _opts$animate === void 0 ? false : _opts$animate,
      _opts$bigClass = opts.bigClass,
      bigClass = _opts$bigClass === void 0 ? 'VCX_big' : _opts$bigClass;
  ...
  var children = Array.prototype.filter.call(container.querySelectorAll("#".concat(id, ">*")), filterDisplayNone);
...
var layout = __webpack_require__(/*! ./layout */ "./src/layout.js");
...
/***/ 0:
/*!********************************!*\
  !*** multi ./src/vcxLayout.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\vinod.r\Desktop\Code\Experiments\layout\src\vcxLayout.js */"./src/vcxLayout.js");
